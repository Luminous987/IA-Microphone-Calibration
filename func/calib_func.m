...
for i = 1:numIterations
    if i == 1
        [Mic_pos_err, Source_pos_err, Time_off_err, Clock_diff_err] = compute_RMS_error(g);
  ...
  % solve the dx
  [dx,H,H_mic] = linearize_and_solve_with_H(g,est_delay_on,est_drift_on,i);
...
elapsedTime = toc; % 结束计时并将经过的时间赋值给变量
